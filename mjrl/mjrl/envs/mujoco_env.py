...
class MujocoEnv(gym.Env):
    ...
    def set_state(self, qpos, qvel):
        #print(f"qpos {qpos.shape}, self.model.nq {self.model.nq}, qvel {qvel.shape}, self.model.nv {self.model.nv}")
    ...
    def mj_render(self):
        try:
            self.viewer.render(width=256,height=256) #width=500,height=500
        except:
    ...
    # def mj_render(self):
    #     try:
    #         # in mj_render, we are in this try branch (when using gym.env.mujoco_py)
    #         self.viewer.render(mode='rgb_array', width=500,height=500)
    #     except:
    #         # in mj_render, we are in this except branch (when using mjrl)
    #         self.mj_viewer_setup()
    #         self.viewer._run_speed = 0.5
    #         #self.viewer._run_speed /= self.frame_skip
    #         self.viewer.render(mode='rgb_array', width=500,height=500) #500,500
