...
from utils.Diffusion_evaluation_gt import Diffusion_policy_control_relocate
    ...
    def __init__(self,
        ...
        for i in range(10): #len(demo_data)
            ...
            for t in range(length):
                ...
                obs = observations[t]
                handpos = obs[:30] 
                obj_pos = np.append(obs[39:42], obs[45:48])
...
e.reset()
Testing_data = e.generate_unseen_data_relocate(133) # CHANGE
