...
from utils.Diffusion_evaluation_gt import Diffusion_policy_control_door
    ...
    def __init__(self,
        ...
        for i in range(10): #len(demo_data)
            ...
            for t in range(length):
                ...
                obj_pos = np.append(obs[32:35], path['init_state_dict']['door_body_pos'])
...
e = GymEnv("door-v0")
e.reset()
Testing_data = e.generate_unseen_data_door(100) 
...
for epoch_idx in range(num_epochs):
    ...
    if (epoch_idx >= 200 and epoch_idx % 100 == 0):
        with torch.no_grad():
