...
from utils.Diffusion_evaluation import Diffusion_policy_control_reorientation
    ...
    def __init__(self,
        ...
        for i in range(50): #len(demo_data)
            ...
            for t in range(length):
                obs = observations[t]
                handpos = np.append(obs[:24], obs[36:39])
...
num_hand = 24+3 # 30 dof of robot + 3 dof of desired pos
...
# device transfer
device = torch.device('cuda:3') #'cuda' # error on nvidia version
_ = nets.to(device)
