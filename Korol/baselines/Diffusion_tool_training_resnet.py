...
from utils.Diffusion_evaluation import Diffusion_policy_control_tool
...
dataset = DiffusionDataset(
    demo_path="./Tool/Data/Hammer_task.pickle",
    img_path='./Tool/Data',
...
save_path = "./Results/Diffusion/tool/ckpts/" + task_name + ".pt"
...
for epoch_idx in range(num_epochs):
    ...
    if (epoch_idx >= 100 and epoch_idx % 25 == 0):
        with torch.no_grad():
            ...
            Diffusion_policy_control_tool("hammer-v0", Controller, ema_nets, Testing_data, dataset.stats, device, obs_horizon, pred_horizon, action_horizon, num_diffusion_iters, noise_scheduler, use_gt = False)
            # vision_encoder.eval()
            # generate_feature(vision_encoder, './Tool/feature_tool_demo_full.pickle', "./Tool/Data", device=device, epoch=epoch_idx)
